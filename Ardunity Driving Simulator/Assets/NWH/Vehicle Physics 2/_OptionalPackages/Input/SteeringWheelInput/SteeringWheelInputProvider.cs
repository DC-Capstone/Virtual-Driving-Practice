...
namespace NWH.VehiclePhysics2.Input
{
    ...
    public class SteeringWheelInputProvider : VehicleInputProviderBase
    {
        ...
        void Start()
        {
            ...
            _damageHandler = vehicleController.GetComponent<DamageHandler>();
        }
        ...
        void FixedUpdate()
        {
            ...
            if (WheelIsConnected && LogitechGSDK.LogiUpdate())
            {
                ...
                {
                    if (_damageHandler.lastCollisionTime + 0.3f > Time.realtimeSinceStartup)
                    {
                        int strength = (int)(_damageHandler.lastCollision.impulse.magnitude / 
